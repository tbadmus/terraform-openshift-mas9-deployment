...
variable "aws_other_subnets" {
  type = list(string)
  default = null
  description = "list of other subnets in the VPC that are not used by the cluster, needed for endpoints"
}
